...
class _EditPageState extends State<EditPage> {
  ...
  void initState() {
    super.initState();
    context.read<NotesViewBloc>().add(InitialEditView(id: widget.id!));
  }
  ...
  Widget build(BuildContext context) {3
    ...
    if (state.editData.isNotEmpty) {
      ...
      editNoteDes.text = state.editData[0][DBHelper.columnNoteDes] ?? '';
    }
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      context.read<NotesBloc>().add(UpdateNote(title: editNoteTitle.text, des: editNoteDes.text, id: widget.id!));
                      Navigator.pop(context);
                    },
                    child: Container(
                      padding: EdgeInsets.all(5),
